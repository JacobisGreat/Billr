    ...
    try {
      ...
      if (!userDoc.exists()) {
        ...
        try {
          ...
          // If offline, still set the profile locally
          if (error.code === 'unavailable') {
            console.log('Offline - setting profile locally');
            setUserProfile(profileData);
          }
        }
      } else {
      ...
      if (error.code === 'unavailable') {
        console.log('Firebase offline - creating temporary profile');
        // Create a temporary profile when offline
