        ...
        >
          <div className="min-h-screen px-4 py-8 flex items-start justify-center">
            <motion.div
              ...
              className="relative w-full max-w-6xl bg-white/90 backdrop-blur-xl border border-brand-200/60 rounded-2xl shadow-brand max-h-[90vh] overflow-hidden flex flex-col"
