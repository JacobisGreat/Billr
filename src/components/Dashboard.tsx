      ...
      <div className="min-h-screen bg-gradient-to-br from-brand-light via-white to-brand-medium flex items-center justify-center">
        ...
        >
          <div className="p-8 rounded-2xl bg-white/90 backdrop-blur-sm border border-brand-medium/20 shadow-lg shadow-brand-medium/10">
            <div className="animate-spin rounded-full h-12 w-12 border-3 border-brand-medium/30 border-t-brand-dark mx-auto mb-4"></div>
            <p className="text-brand-dark/80 font-medium">Loading authentication...</p>
          </div>
        </motion.div>
      </div>
    );
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-brand-light via-white to-brand-medium flex items-center justify-center">
        ...
        >
          <div className="p-8 rounded-2xl bg-white/90 backdrop-blur-sm border border-brand-medium/20 shadow-lg shadow-brand-medium/10">
            <div className="animate-spin rounded-full h-12 w-12 border-3 border-brand-medium/30 border-t-brand-dark mx-auto mb-4"></div>
            <p className="text-brand-dark/80 font-medium">Loading your dashboard...</p>
          </div>
        </motion.div>
      </div>
    );
